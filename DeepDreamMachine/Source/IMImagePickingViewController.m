...
- (void)viewDidLoad {
  ...
  [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(updatePasteboardButton) name:UIPasteboardChangedNotification object:nil];
  [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(updatePasteboardButton) name:UIApplicationDidBecomeActiveNotification object:nil];
  [self.example1Button.imageView setContentMode:UIViewContentModeScaleAspectFit];
  [self.example2Button.imageView setContentMode:UIViewContentModeScaleAspectFit];
  [self.example3Button.imageView setContentMode:UIViewContentModeScaleAspectFit];
...
- (IBAction)exampleButtonPressed:(UIButton *)sender {
    NSURL *url = [[NSBundle mainBundle] URLForResource:[NSString stringWithFormat:@"sample%d",sender.tag] withExtension:@"jpg"];
